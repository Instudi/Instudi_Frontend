      ...
      <div
        ...
        <div
          ...
          <CrButton
            ...
            outerClass={`w-[80%] md:w-[clamp(6rem,12vw,11em)] ${isClicked ? '!cursor-wait' : ''
              }`}
        ...
        <div
          className={`absolute items-center lg:divide-x-4 lg:divide-dashed lg:divide-yellow-500 lg:content-stretch lg:relative lg:flex-row flex flex-col w-full h-full lg:h-[45%] transition-all duration-[2000ms] ${isClicked || windowWidth >= 1024
            ? isSectionConfirmed
